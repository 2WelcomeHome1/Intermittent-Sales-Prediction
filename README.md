...
В третьем эксперименте алгоритм работал с полным набором данных (>1000 дней) высокочастотной номенклуатауры. Но проверка осуществлялась только последних **40** дней. В результате **нелозакуп составил 2 еденицы товара (7 из 9)**.
